...
/**
 * Tool for getting search index details.
 *
 * @Tool(
 *   id = "mcp_search_api_get_index",
 *   label = @Translation("Get Search Index"),
 *   description = @Translation("Get detailed information about a search index including fields, datasources, and status."),
 *   category = "search_api",
 * )
 */
class GetIndex extends ToolPluginBase implements ContainerFactoryPluginInterface {
