...
/**
 * Tool for disabling/uninstalling a theme.
 *
 * @Tool(
 *   id = "mcp_theme_disable",
 *   label = @Translation("Disable Theme"),
 *   description = @Translation("Disable/uninstall a theme. Cannot disable the default or admin theme."),
 *   category = "theme",
 * )
 */
class DisableTheme extends ToolPluginBase implements ContainerFactoryPluginInterface {
  ...
  public function getInputDefinition(): array {
    return [
      'theme' => [
        ...
        'label' => 'Theme',
        'required' => TRUE,
        'description' => 'Machine name of the theme to disable',
      ],
    ];
  }
