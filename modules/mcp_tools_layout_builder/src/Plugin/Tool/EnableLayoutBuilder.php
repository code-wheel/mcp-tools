 ...
 *   label = @Translation("Enable Layout Builder"),
 *   description = @Translation("Enable Layout Builder for a content type."),
 *   category = "layout_builder",
 * )
 */
class EnableLayoutBuilder extends ToolPluginBase implements ContainerFactoryPluginInterface {
