...
#[Tool(
  ...
  label: new TranslatableMarkup('Remove Section'),
  description: new TranslatableMarkup('Remove a layout section from the default layout.'),
...
class RemoveSection extends McpToolsToolBase {
