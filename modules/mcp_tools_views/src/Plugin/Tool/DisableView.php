 ...
 * @Tool(
 *   id = "mcp_disable_view",
 *   label = @Translation("Disable View"),
 *   description = @Translation("Disable an enabled view."),
 *   category = "views",
 * )
 */
class DisableView extends ToolPluginBase implements ContainerFactoryPluginInterface {
